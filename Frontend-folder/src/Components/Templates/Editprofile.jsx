            ...
            <form 
              ...
              className='edit relative flex items-center gap-14 justify-center flex-col h-[55%] w-[100%] p-2'>
                ...
                <input 
                 ...
                 />
                <button type='submit' className="w-[265px] flex justify-center py-2 rounded-md shadow-sm text-md font-semibold text-white bg-gradient-to-r from-[#1289F4] via-[#5042A7] to-[#CF0C72] hover:text-black hover:scale-105 duration-200">
                 Update Profile
                </button>
                </div>
