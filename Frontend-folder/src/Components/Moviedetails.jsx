  ...
  return info ? (
    ...
    >
      ...
      <div className="relative w-full flex flex-col text-white bg-[#ffffff80] rounded-lg p-2 mt-2">
        ...
        <Link
            className="shadow-[2px_4px_4px_rgba(0,1,0,0.5)] absolute top-[94%] left-[2%] p-2 bg-gradient-to-r from-[#1289F4] via-[#5042A7] to-[#CF0C72] font-medium rounded-lg hover:text-black hover:scale-105 duration-200"
            to={`${pathname}/trailer`}
          >
            {" "}
