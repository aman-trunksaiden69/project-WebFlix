  ...
  return info ? (
    ...
    >
      ...
      <div className="relative w-full flex flex-col text-white bg-[#ffffff80] rounded-lg p-2 mt-2">
        ...
        <Link
          className="shadow-[2px_4px_4px_rgba(0,1,0,0.5)] absolute top-[94%] left-[60%] p-2 bg-blue-700 font-medium rounded-lg hover:bg-blue-400 hover:scale-110 duration-75"
          to={`${pathname}/trailer`}
        >
          {" "}
